\chapter{Materiais e Métodos}
    ...
    As ondas eletromagnéticas penetram no interior da Terra na forma de ondas planas ortogonais que induzem novas correntes chamadas de corrente telúricas que trazem informações das características físicas das litologias. \citar{fonte}
...
%========================================================================================================================================================    
    \section{Ferramentas de Desenvolvimento do \textit{Software} \,\,\,\,\,\,\, OK}
        ...
        Os \en{scripts} oferecidos para o processamento MT foram desenvolvidos pelo \citar{Dr. Marcelo Banik de Pádua....}
        
        A natureza dos pacotes são \en{scripts} em \en{Shell} que utilizam o programa GMT para plotagem dos gráficos e o núcleo de processamento dos dados são as rotinas propostas por \citeauthor{egbert97} e \citar{JONES}, disponíveis \citar{no site ou pela fundação.... tem que ver o que é}
