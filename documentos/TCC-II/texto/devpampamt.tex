\chapter{DESENVOLVIMENTO E RESULTADOS DO PampaMT}
    ...
    \end{figure}
     ...
     Após a escolha do diretório para um novo projeto, o usuário é direcionado a escolha dos arquivos \en{TS}, nele o usuário pode escolher entre três equipamentos: ADU-06, ADU-07 e Lins, a seleção pode ser automática ou estação á estação (figura \ref{tela_sel_site}). 
