...
\end{footnotesize}
        ...
        A partir dos arquivos \en{Z} ou \en{.zss}, pode-se calcular a resitividade aparente ($\rho_a$) a partir da seguinte equação \cite{z-files}:
        ...
        A estrutura base utilizada para os dados é composta por quatro sub-blocos, cada um representando uma componente do tensor. O bloco é divido em cinco colunas, onde assumem respectivamente a seguinte ordem: 
...
\end{footnotesize}
    ...
    \section{Processamento Robusto -- EMTF}
        \label{sec-robusto}
            ...
            O processamento dos dados parte primeiramente da análise espectral, onde primeiro faz-se necessário a mudança do domínio do tempo para a frequência angular e em seguida a filtragem, remoção de tendências e dados ruins.
    ...
    \section{Pacotes de Processamento do Grupo Geoma -- INPE}
        ...
        Os \en{scripts} oferecidos para o processamento MT foram desenvolvidos, em grande parte, pelo Dr. Marcelo Banik de Pádua e pelo Ms. Marcelo Banik de Pádua, os mesmo \en{scripts} foram obtidos sobre comunicação privada pelo autor.
