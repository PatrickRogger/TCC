\chapter{FUNDAMENTOS DO MÉTODO MAGNETOTELÚRICO}
    ...
    \section{Resposta do Método Magnetotelúrico}
        ...
        O \mt{} assim como os outros método geofísicos eletromagnéticos, fundamentam-se nas Leis de Maxwell [\ref{lei-max-rotE} -- \ref{lei-max-divD}].
        ...
        Na faixa da sondagem MT a Terra comporta-se como um condutor ôhmico, isso implica que o meio não possue cargas livres, logo $\varrho \simeq 0$. 
        ...
        \begin{figure}[H]
            \caption{Gráfico do \en{skin-depth} em função da frequência [$Hz$]}
            \begin{center}
                \includegraphics[width=10cm]{fig/grafico_skin_depth.png}
            \end{center}
            \legend{\Fonte{\oautor.}}
        \end{figure}
        
        
        \citar{Breve descrição d gráfico}
        ...
        A partir da equação são mapeadas as litologias relacionando-as com a $\rho_a$.
    ...
    \section{Impedância Eletromagnética}
        ...
        \noindent Onde $\vetor{k}$ é o vetor de onda cujo o módulo é definido na equação \ref{kappaquad}
