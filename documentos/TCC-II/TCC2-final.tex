...
\begin{siglas}
    ...
    \siglae{            -- Código Padrão Norte-americano para Intercâmbio de Informações}
    \\
    \sigla{API}{    \en{Application Programming Interface}}
    \siglae{            -- Interface de Programação de Aplicações}
    \\
    ...
    \siglae{            -- Interface Gráfica do Utilizador}
    \\
