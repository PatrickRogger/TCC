...
% ===================================
\begin{resumo}
 Este trabalho trata do desenvolvimento um Software para o processamento de dados magnetotelúrico (MT), esse projeto foi idealizado visto a carência de programas para o trabalho com magnetotelúrico. O programa desenvolvido realiza as etapas de processamento dos dados desde a coleta, através de equipamentos do tipo Metronix ADU06 ou ADU07, até as etapas de visualização, passando por processamentos estatísticos, conversão de formatos de arquivos e processamento robusto. Todo o programa foi desenvolvido utilizando a linguagem de programação Python sob a licença de software Livre, o programa une inúmeros programas, scripts e rotinas consagrados no processamento de dados magnetotelúrico, onde esses processamentos serão feitos através de uma interface gráfica, visando então facilitar as etapas de processamentos para os novos usuários. Atualmente os programas livres disponíveis para o processamento de dados, realizam exclusivamente os processos através de linhas de comando, esse fato muitas vezes afastam novos pesquisadores para a área e restringem o processamento a pequenos núcleos. O intuito final do trabalho é tornar o processamento MT mais dinâmico através deste novo programa.
\end{resumo}
% ===================================
