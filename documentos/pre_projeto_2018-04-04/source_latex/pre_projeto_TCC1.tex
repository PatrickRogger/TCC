...
\chapter{Materiais e Métodos}
	...
	Os campos podem ser descritos pelas equações a seguir para carga e corrente livre
	(macroscópica):
	    \begin{equation}
		\label{rot_elet_max}
...
\chapter{Resultados Esperados}
    ...
    No final do projeto serão liberados os códigos para a comunidade geofísica 
    onde outras pessoas possam contribuir.
    Como resultado é esperado que a produtividade aumentada, a aprendizagem do método MT seja mais difuldida e que novos trabalhos possam ser feitos usando o programa.
    
    \textcolor{red}{não sei mais o que por }
